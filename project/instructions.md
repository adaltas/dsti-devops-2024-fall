...
1. **ATTENTION!** Make sure your repository is **PRIVATE** and **you have sent an invitation** to teacher's GitHub account - https://github.com/mohamedoud. Otherwise, **if it isn't PRIVATE the final grade will be reduced to 0**.

2. After you have sent the invitation, send an email to [mohamed@adaltas.com](mailto:mohamed@adaltas.com) containing the following:
